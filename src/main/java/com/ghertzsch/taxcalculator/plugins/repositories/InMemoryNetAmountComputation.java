...
import com.ghertzsch.taxcalculator.domain.
...
public class InMemoryNetAmountComputation implements
  NetAmountComputationRepository {

  private final ArrayList<NetAmountComputation> netAmountComputations
    = new ArrayList<>();

  @Override
  public void storeComputation(NetAmountComputation netAmountComputation) {
    var netAmountComputationIndex =
      netAmountComputations.indexOf(netAmountComputation);
    if (netAmountComputationIndex != -1) {
      netAmountComputations.set(netAmountComputationIndex,
